...
export const VISUALS: Visual[] = [
    ...
    {
        slug: "auto-single-select-slicer",
        num: "11",
        name: "Auto Single Select Slicer",
        pitch: "Smart Power BI slicer with automatic first-value selection — reports never load with an empty filter.",
        featuresShort: [
            "Auto-selects the first value on load",
            "Compact dropdown, single-select only",
            "Selection persists through filter updates",
        ],
        description: [
            "Business users frequently work with reports where slicers need a meaningful default state instead of starting empty. Users often need the first available value selected automatically so reports always have a valid filter context on load. Traditional slicers require manual interaction and can create inconsistent report experiences, especially when filters change dynamically.",
            "Auto Single Select Slicer solves this by introducing intelligent automatic selection behavior. In Single Select mode, the visual automatically selects the first available value on initial load and maintains a valid selection even when filters affect available values — ensuring reports never have an empty or null filter context.",
            "The visual uses a compact Dropdown layout, integrating cleanly into any report canvas without consuming excessive space. It supports Power BI interactions such as cross filtering and maintains the selection dynamically when connected visuals update the available dataset.",
            "Formatting options such as font size, bold, italic, underline, padding, borders, background colors, and styling behaviors apply consistently across all slicer elements. The visual integrates naturally with Power BI and improves report usability by eliminating repetitive manual selection while keeping the interface simple and focused.",
        ],
        featuresFull: [
            "Auto-select first value on load for Single Select mode",
            "Dropdown layout with compact, clean interface",
            "Single Select mode with dropdown-only selection",
            "Selection persistence after filtering updates",
            "Custom slicer header with title, font color, and show summary",
            "Dynamic summary display for the selected value",
            "Background, font, border, and padding customization",
            "Bold, italic, and underline support across all slicer elements",
        ...
        /* TODO: replace "#" with the Microsoft AppSource product URL once published */
        appSourceUrl: "#",
        tutorialUrl: "https://www.youtube.com/watch?v=rzIxm5B7hcI",
        previewSrc: "/cbt-custom-visuals/auto-single-select-slicer.png",
    },
    {
        slug: "autoselect-slicer",
        num: "12",
        name: "AutoSelect Slicer",
        pitch: "Smart Power BI slicer with automatic selection across single-select and multi-select scenarios.",
        featuresShort: [
            "Auto-select first value or all values on load",
        ...
        /* TODO: replace "#" with the Microsoft AppSource product URL once published */
        appSourceUrl: "#",
        tutorialUrl: "https://www.youtube.com/watch?v=YUEjf1_zqzY",
        previewSrc: "/cbt-custom-visuals/autoselect-slicer.png",
    },
];
