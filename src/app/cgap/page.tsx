...
export default async function CGAPPage() {
    ...
    return (
        <>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <div className="flex items-center gap-2 mb-4">
                                <GraduationCap size={20} className="text-persona-cgap" />
                                <span className="text-xs font-bold uppercase tracking-[0.2em] text-persona-cgap">
                                    Graduate Program
                                </span>
                            </div>
                            ...
                            <div className="mt-8 flex flex-col sm:flex-row items-center gap-6">
                                <a
                                    ...
                                    className="btn-primary bg-persona-cgap hover:bg-persona-cgap/90 text-white min-w-[200px] justify-center py-4 text-lg"
                                >
                                    Apply Now
                                    <ExternalLink size={20} />
                                </a>
                                <div className="text-center sm:text-left">
                                    <a href="#curriculum" className="text-mid-grey font-semibold hover:text-persona-cgap transition-colors flex items-center gap-2">
                                        View Curriculum
                                        <ArrowRight size={16} />
                                    </a>
                                    <p className="text-[10px] text-mid-grey mt-1 font-mono opacity-60">Redirects to: {applicationUrl}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative h-[300px] md:h-[400px]">
                            ...
                            <div className="absolute -bottom-6 -left-6 grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    >
                                        <div className="text-xl font-bold text-persona-cgap">
                                            {stat.number}
                                        </div>
            ...
            <section className="bg-light-grey">
                <div className="container-main section-padding">
                    <div className="text-center mb-12">
                        <span className="inline-block text-xs font-bold uppercase tracking-[0.2em] text-persona-cgap bg-tag-bg-red px-3 py-1.5 rounded-full mb-4">
                            About
                        </span>
                            ...
                            return (
                                ...
                                >
                                    <div className="relative flex flex-col items-center">
                                        <div className="w-11 h-11 rounded-lg bg-white flex items-center justify-center shadow-sm group-hover:bg-persona-cgap transition-colors duration-200 shrink-0">
                                            <Icon
                                                size={20}
                                    ...
                                    <div className="pb-4">
                                        <span className="text-xs font-bold text-persona-cgap uppercase tracking-wider">
                                            {item.month}
                                        </span>
                    ...
                    <div className="max-w-2xl mx-auto space-y-3">
                        {eligibility.map((item) => (
                            <div key={item} className="flex items-start gap-3">
                                <CheckCircle2
                                    size={18}
                                    className="text-persona-cgap shrink-0 mt-0.5"
                                />
                ...
                <div className="container-main section-padding">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {displayAlumni.map((alum: any) => (
                            ...
                            >
                                <Quote size={24} className="text-persona-cgap/20 mb-3" />
            ...
            <section className="bg-light-grey">
                <div className="container-main section-padding">
                    ...
                    <div className="text-center mt-8">
                        <Link
                            href="/customers"
                            className="inline-flex items-center gap-2 text-sm font-semibold text-persona-cgap hover:gap-3 transition-all duration-200"
                        >
                            See All Clients
                            <ArrowRight size={14} />
                        </Link>
            ...
            {/* Apply CTA */}
            <section className="bg-persona-cgap">
                <div className="container-main py-20 md:py-28 text-center text-white">
                    <GraduationCap size={60} className="text-white/20 mx-auto mb-6" />
                    <h2 className="text-3xl md:text-5xl font-extrabold mb-6">
                        Ready to Launch Your Career?
                    </h2>
                    <p className="text-white/80 mb-10 max-w-2xl mx-auto text-lg">
                        Applications for the next cohort are now open. Start your journey into the world of high-impact data consulting.
                    </p>
                    <div className="flex flex-col items-center gap-4">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-3 bg-white text-persona-cgap font-bold px-10 py-5 rounded-full text-xl hover:bg-white/90 shadow-2xl shadow-black/20 transition-all"
                        >
                            Apply Now
                            <ExternalLink size={24} />
                        </a>
                        <p className="text-xs text-white/50 font-mono">Redirects to recruitment portal: {applicationUrl}</p>
                    </div>
                </div>
            </section>
